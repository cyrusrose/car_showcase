...
export type CarMakeRespond = {
  __typename?: 'CarMakeRespond';
...
export type CarPage = {
  ...
  makeCount?: Maybe<CarMakeRespond>;
  nodes: Array<Car>;
  pageInfo: PageInfo;
